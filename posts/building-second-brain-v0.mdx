...
Building a first draft app is now surprisngly easly regardless of your background. However, scope creep is also now easier than ever. 
Build the bare minimum, get it to work, then iterate. Additionally, I predict that product taste will become more important than ever. 
When the barrier to entry for a new product is next to nothing and the "out of the box" AI generated content looks similar to everyone 
else's "average of the internet" content (...like this website, actually), product taste will be more valuable than ever because it's difficult to hack with AI. 
You need to know what you want the experience to *feel* like and who you're building it for, or you risk having your super quirky, fun new app 
